 ...
 */
final class Version20220402113444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3115E93F4B89032C ON hoyolab_post (post_id)');
        $this->addSql('ALTER TABLE hoyolab_post_discord_notification DROP FOREIGN KEY FK_9ED79E48865B6A03');
        $this->addSql('DROP INDEX UNIQ_9ED79E48865B6A03 ON hoyolab_post_discord_notification');
        $this->addSql('ALTER TABLE hoyolab_post_discord_notification DROP process_stats_id, DROP channel_id, DROP guild_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_3115E93F4B89032C ON hoyolab_post');
        $this->addSql('ALTER TABLE hoyolab_post_discord_notification ADD process_stats_id INT DEFAULT NULL, ADD channel_id VARCHAR(15) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, ADD guild_id VARCHAR(15) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_9ED79E48865B6A03 ON hoyolab_post_discord_notification (process_stats_id)');
    }
}
