 ...
 */
final class Version20220219144129 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hoyolab_post DROP FOREIGN KEY FK_3115E93FA76ED395');
        $this->addSql('DROP INDEX IDX_3115E93FA76ED395 ON hoyolab_post');
        $this->addSql('ALTER TABLE hoyolab_post CHANGE user_id hoyo_user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hoyolab_post CHANGE hoyo_user_id user_id INT NOT NULL');
        $this->addSql('ALTER TABLE hoyolab_post ADD CONSTRAINT FK_3115E93FA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_3115E93FA76ED395 ON hoyolab_post (user_id)');
    }
}
